...
//		indexButton.addMouseListener(new SearchButtonListener(indexButton, query, this));
	...
	public void setCrawlButton () {
		crawl = new JButton("Calculate PageRanks");
		crawl.setBounds(200, 240, 790, 40);
		crawl.setBackground(Color.BLUE);
		crawl.setFont(new Font("Tahoma", 15, 16));
		crawl.addMouseListener(new PagerankButtonListener(crawl, urls, number, indegtext, outdegtext));
...
class PagerankButtonListener implements MouseListener {
	...
	public PagerankButtonListener(JButton jbb, JTextField jtff1, JTextField jtff2, 
	...
	public void mouseClicked(MouseEvent arg0) {
		PagerankStatusBar progressBar = new PagerankStatusBar("PageRanking", 
				Double.parseDouble(number.getText())
				, Double.parseDouble(urls.getText()));
		progressBar.start();
	}
